    ...
    <header className="h-14 bg-slate-900/95 backdrop-blur-sm border-b border-slate-700/50 flex items-center px-4 gap-4 z-[600] relative">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-[10px] text-slate-500 leading-none mt-0.5">Live AIS · 20 Major Ports · Real-time D&D Pricing</p>
        </div>
      </div>
      ...
      <div className="ml-auto flex items-center gap-3">
        ...
        {isSnapshot && (
          <div className="hidden sm:flex items-center gap-1.5 px-2.5 py-1 bg-amber-500/10 border border-amber-500/30 rounded-full" title="Set a dedicated AISSTREAM_API_KEY in Vercel env vars for live data">
